...
describe('array module', () => {
  ...
  describe('replace function', () => {
    ...
    test('returns replaced item by index', () => {
      const result = _.replace(['a', 'b', 'c', 'd'], 'BB', (_l, idx) => idx === 1);
  ...
  describe('intersects function', () => {
    ...
    test('returns false without failing if either list is null', () => {
      expect(_.intersects(null as unknown as never, [])).toBeFalse();
      expect(_.intersects([], null as unknown as never)).toBeFalse();
    });
  });
  ...
  describe('replaceOrAppend', () => {
    ...
    test('returns empty array for two null inputs', () => {
      const result = _.replaceOrAppend(NULL, null, (_x) => false);
      expect(result).toEqual([]);
    });
    test('returns array with new item for null list input', () => {
      const result = _.replaceOrAppend(NULL, 'a', (_x) => false);
      expect(result).toEqual(['a']);
    });
    test('returns list for null new item input', () => {
      const result = _.replaceOrAppend(['a'], null, (_x) => false);
      expect(result).toEqual(['a']);
    });
    test('returns list with item replacing match by index', () => {
      const result = _.replaceOrAppend(['a', 'b', 'c', 'd'], 'BB', (_l, idx) => idx === 1);
      expect(result[1]).toEqual('BB');
    });
  ...
  describe('diff function', () => {
    ...
    test('uses identity function', () => {
      ...
      const result = _.diff([letter('a'), letter('b'), letter('c')], [letter('c'), letter('d'), letter('e')], identity);
  ...
  describe('toggle function', () => {
    ...
    test('should remove item when it does exist using custom matcher', () => {
      const result = _.toggle([{ value: 'a' }, { value: 'b' }], { value: 'b' }, (v) => v.value);
