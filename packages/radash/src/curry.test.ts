...
describe('curry module', () => {
  describe('compose function', () => {
    test('composes functions', () => {
      ...
      const objectize = (fn: (obj: { num: number }) => number) => (num: number) => fn({ num });
      const increment =
    ...
    test('composes async function', async () => {
      ...
      const objectize = (fn: (obj: { num: number }) => Promise<number>) => async (num: number) => fn({ num });
      const increment =
    ...
    test('composes function type overloads', () => {
      ...
      expect(_.compose(useZero, objectize, increment, returnArg('num'))()).toEqual(1);

      expect(_.compose(useZero, objectize, increment, increment, returnArg('num'))()).toEqual(2);

      expect(_.compose(useZero, objectize, increment, increment, increment, returnArg('num'))()).toEqual(3);

      expect(_.compose(useZero, objectize, increment, increment, increment, increment, returnArg('num'))()).toEqual(4);

      expect(
        _.compose(useZero, objectize, increment, increment, increment, increment, increment, returnArg('num'))(),
      ).toEqual(5);
  ...
  describe('chain function', () => {
    test('calls all given functions', () => {
      const genesis = (_num: number, _name: string) => 0;
