...
describe('UTCDateMini', () => {
  test('creates date in UTC', () => {
    expect(new UTCDateMini(1987, 1, 11).getTime()).toBe(Date.UTC(1987, 1, 11));
  });
  ...
  describe('getters', () => {
    test('getDate returns UTC date', () => {
      expect(new UTCDateMini(1987, 1, 11, 23).getDate()).toBe(11);
    });

    test('getDay returns UTC day', () => {
      expect(new UTCDateMini(1987, 1, 11, 23).getDay()).toBe(3);
    });

    test('getFullYear returns UTC full year', () => {
      expect(new UTCDateMini(1999, 11, 31, 23).getFullYear()).toBe(1999);
    });

    test('getHours returns UTC hours', () => {
      expect(new UTCDateMini(1987, 1, 11, 3).getHours()).toBe(3);
    });

    test('getMilliseconds returns UTC milliseconds', () => {
      expect(new UTCDateMini(1987, 1, 11, 3, 30, 15, 123).getMilliseconds()).toBe(123);
    });

    test('getMinutes returns UTC minutes', () => {
      expect(new UTCDateMini(1987, 1, 11, 3, 30).getMinutes()).toBe(30);
    });

    test('getMonth returns UTC month', () => {
      expect(new UTCDateMini(1999, 11, 31, 23).getMonth()).toBe(11);
    });

    test('getSeconds returns UTC seconds', () => {
      expect(new UTCDateMini(1987, 1, 11, 3, 30, 15).getSeconds()).toBe(15);
    });

    test('getTimezoneOffset returns 0', () => {
      expect(new UTCDateMini(1999, 11, 31, 23).getTimezoneOffset()).toBe(0);
    });
  });

  describe('setters', () => {
    test('setDate sets UTC date', () => {
      const date = new UTCDateMini(1987, 1, 11, 23);
      date.setDate(12);
    ...
    test('setFullYear sets UTC full year', () => {
      const date = new UTCDateMini(1999, 11, 31, 23);
    ...
    test('setHours sets UTC hours', () => {
      const date = new UTCDateMini(1987, 1, 11, 3, 30);
      date.setHours(4);
    ...
    test('setMilliseconds sets UTC milliseconds', () => {
      const date = new UTCDateMini(1987, 1, 11, 3, 30, 15, 0);
    ...
    test('setMonth sets UTC months', () => {
      const date = new UTCDateMini(1999, 11, 15, 23);
      date.setMonth(10);
    ...
    test('setSeconds sets UTC seconds', () => {
      const date = new UTCDateMini(1987, 1, 11, 3, 30, 0);
      date.setSeconds(45);
