...
describe('formatBytes', () => {
  test('normal usage', () => {
    ...
    expect(formatBytes(1111, { decimals: 1 })).toEqual('1.1 KB');
    expect(formatBytes(1111, { decimals: 2 })).toEqual('1.08 KB');
    expect(formatBytes(1111, { decimals: 3 })).toEqual('1.085 KB');
