...
export const DIC_ALPHANUMERIC = DIC_NUMBERS + DIC_LOWERCASE + DIC_UPPERCASE;
export const DIC_HEXADECIMAL_UPPERCASE = DIC_NUMBERS + 'ABCDEF';
export const DIC_HEXADECIMAL_LOWERCASE = DIC_NUMBERS + 'abcdef';
